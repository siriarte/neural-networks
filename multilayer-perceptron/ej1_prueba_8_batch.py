...
def variacion_batch():
    ...
    # Entreno red - Momentum = 0.1
    red_1 = rn.RedNeuronal(cantidad_neuronas_entrada, [10, 10], cantidad_neurona_salida, 0, 5, 0, 0, 0, '')
    ...
    red_2 = rn.RedNeuronal(cantidad_neuronas_entrada, [10, 10], cantidad_neurona_salida, 0, 10, 0, 0, 0, '')
    ...
    red_3 = rn.RedNeuronal(cantidad_neuronas_entrada, [10, 10], cantidad_neurona_salida, 0, 100, 0, 0, 0, '')
    ...
    red_4 = rn.RedNeuronal(cantidad_neuronas_entrada, [10, 10], cantidad_neurona_salida, 0, 500, 0, 0, 0, '')
    ...
    plt.savefig("graficos\\ej1_prueba_8_batch_entrenamiento.png")
    #plt.show()
    ...
    plt.grid(True)
    plt.legend(loc='upper right', frameon=False)
    plt.savefig("graficos\\ej1_prueba_8_batch_validacion.png")
    #plt.show()


    print('Batch = 1 ---> TEST = %f' % (red_0.test_ej1(datos_testing_entrada, datos_testing_resultados)))
    print('Batch = 5 ---> TEST = %f' % (red_1.test_ej1(datos_testing_entrada, datos_testing_resultados)))
    print('Batch = 10 ---> TEST = %f' % (red_2.test_ej1(datos_testing_entrada, datos_testing_resultados)))
    print('Batch = 100 ---> TEST = %f' % (red_3.test_ej1(datos_testing_entrada, datos_testing_resultados)))
    print('Batch = 500 ---> TEST = %f' % (red_4.test_ej1(datos_testing_entrada, datos_testing_resultados)))
