...
def variacion_parametros_adaptativos():
    ...
    # Entreno red - Momentum = 0.1
    red_1 = rn.RedNeuronal(cantidad_neuronas_entrada, [5, 5], cantidad_neurona_salida, 0, 1, 0, 1, 0, '')
    ...
    plt.savefig("graficos\\ej2_prueba_6_param_adaptativos_entrenamiento.png")
    #plt.show()
    ...
    plt.grid(True)
    plt.legend(loc='upper right', frameon=False)
    plt.savefig("graficos\\ej2_prueba_6_param_adaptativos__validacion.png")
    #plt.show()

    # Imprimo nivel de testing
    print('Sin parametros adaptativos ---> TEST = %f' % (red_0.test_ej2(datos_testing_entrada, datos_testing_resultados)))
    print('Con parametros adaptativos ---> TEST = %f' % (red_1.test_ej2(datos_testing_entrada, datos_testing_resultados)))
